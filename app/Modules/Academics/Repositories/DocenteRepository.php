...
class DocenteRepository
{
    ...
    public function all(array $filtros = []): Collection
    {
        ...
        return Docente::query()
            ->with(['usuario.rol', 'carreraAreas.materia', 'materias', 'convocatorias', 'grupos'])
    ...
    {
        return Docente::with(['usuario.rol', 'carreraAreas.materia', 'materias', 'convocatorias', 'grupos'])->find($id);
    }
}
